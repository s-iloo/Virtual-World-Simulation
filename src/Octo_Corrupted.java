...
public class Octo_Corrupted extends Move{

    private static final PathingStrategy CRAB_PATHING = new
            AstarPathingStrategy();


    public Octo_Corrupted(String id, Point position, List<PImage> images, int actionPeriod, int animationPeriod){
                              ...
                              ImageStore imageStore, EventScheduler scheduler)
    {
        Optional<Entity> crabTarget = world.findNearest(
                super.getPosition(), Octo_Not_Full.class);
